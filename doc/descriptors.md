# Support for Output Descriptors in Wednesdaydudecoin Core

Since Wednesdaydudecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Wednesdaydudecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Wednesdaydudecoin Core wallets, a convenience function `combo` is
