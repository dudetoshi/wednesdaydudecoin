Wednesdaydudecoin Core version *0.15.1* is now available from:

  <https://download.wednesdaydudecoin.org/wednesdaydudecoin-0.15.1/>
...
A number of changes to the way Wednesdaydudecoin Core deals with peer connections and invalid blocks
