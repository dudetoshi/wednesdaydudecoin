...
#if defined(NDEBUG)
# error "Wednesdaydudecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Wednesdaydudecoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("wednesdaydudecoin-scriptch");
