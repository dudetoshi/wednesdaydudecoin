...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " wednesdaydudecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  wednesdaydudecoin-tx [options] <hex-tx> [commands]  Update hex-encoded wednesdaydudecoin transaction\n" +
            "or:     wednesdaydudecoin-tx [options] -create [commands]   Create hex-encoded wednesdaydudecoin transaction\n" +
            "\n";
