...
"""Verify that starting wednesdaydudecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start wednesdaydudecoin with -h for help text")
        ...
        self.log.info("Start wednesdaydudecoin with -version for version information")
        ...
        self.log.info("Start wednesdaydudecoind with -fakearg to make sure it does not start")
